package me.shib.security.codefender.scanners.javascript.retirejs;
...
public final class RetirejsScanner extends Codefender {
    ...
    public RetirejsScanner(CodefenderConfig config) throws CodefenderException {
        super(config);
    }
    ...
    private void retirejsExecutor(String command) throws CodefenderException, IOException, InterruptedException {
    ...
    private void npmProjectBuild() throws CodefenderException, IOException, InterruptedException {
        System.out.println("Building Project...");
        retirejsExecutor("npm install");
    }

    private void runRetireJS() throws CodefenderException, IOException, InterruptedException {
    ...
    private void parseResultData(File file) throws IOException, CodefenderException {
