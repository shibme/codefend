...
import me.shib.security.codeinspect.CodeInspectPriority;
...
final class BrakemanPriorityCalculator {
    ...
    private static final CodeInspectPriority[][] priorityConfidenceMatrix = new CodeInspectPriority[][]{
            {CodeInspectPriority.P0, CodeInspectPriority.P1, CodeInspectPriority.P2},
            {CodeInspectPriority.P1, CodeInspectPriority.P1, CodeInspectPriority.P2},
            {CodeInspectPriority.P2, CodeInspectPriority.P2, CodeInspectPriority.P3},
            {CodeInspectPriority.P3, CodeInspectPriority.P3, CodeInspectPriority.P3}
    };
    ...
    static CodeInspectPriority getCodeInspectPriority(String type, String confidence) {
